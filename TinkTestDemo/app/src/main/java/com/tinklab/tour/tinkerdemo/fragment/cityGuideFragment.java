...
public class cityGuideFragment extends Fragment implements tourGuideView {

    private RecyclerView mSyncRecyclerview;
    private View mView;
    cityGuideCircleAdapter mAdapter;
    private int type = 1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new cityGuideCircleAdapter(getActivity(),type);
        mSyncRecyclerview.setAdapter(mAdapter);
        presenter = new tourGuidePresenterImpl(this);
        presenter.getCityGuideDatas();
        return mView;
    }
    ...
    class cityGuideCircleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

        private Context mContext;
        private View mView;
        private int type = -1;

        public cityGuideCircleAdapter(Context mContext, int type) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            cityGuideFragment.MyCircleHolder myCircleHolder = new cityGuideFragment.MyCircleHolder(mView);
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder mHolder, final int position) {
            ...
            holder.img_logo.setImageDrawable(mContext.getDrawable(R.drawable.sz));
            holder.txt_name.setText(mDatas.get(position));
            holder.mInfoItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getActivity(),"your click city position"+position, Toast.LENGTH_LONG).show();
                }
            });
        }
